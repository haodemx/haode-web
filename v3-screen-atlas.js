(() => {
  ...
  const mapPinIcon = '<svg class="store-map-pin" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 21s7-6.1 7-12a7 7 0 1 0-14 0c0 5.9 7 12 7 12Z"/><circle cx="12" cy="9" r="2.5"/></svg>';
  ...
  function footer(){
    const social=(name,url,icon)=>`<a data-social-link="${name.toLowerCase()}" href="${url}" target="_blank" rel="noopener noreferrer" aria-label="${name} de HAODE México"><svg viewBox="0 0 24 24" aria-hidden="true">${icon}</svg></a>`;
    return `<footer class="zay-footer" data-zay-footer data-v3-footer data-site-sales-footer><div class="zay-footer-grid"><section class="zay-footer-brand"><img src="/assets/images/haode-header-logo-horizontal-preview.png" alt="HAODE"><p>Pantallas y tecnología para técnicos, talleres, tiendas y distribuidores en México.</p><div class="zay-socials" aria-label="Redes sociales">${social('Facebook','https://www.facebook.com/haodemx','<path d="M14 8h3V4h-3c-3 0-5 2-5 5v2H6v4h3v7h4v-7h3l1-4h-4V9c0-.7.3-1 1-1Z"/>')}${social('Instagram','https://www.instagram.com/cristi3an/','<rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1"/>')}${social('TikTok','https://www.tiktok.com/@haodemx','<path d="M14 3v11.5a4.5 4.5 0 1 1-4-4.47V14a1.8 1.8 0 1 0 1 1.62V3h3Zm0 0c.4 2.4 1.8 3.8 4 4.2V11c-1.6-.2-2.9-.8-4-1.7"/>')}${social('YouTube','https://www.youtube.com/@haodemx','<rect x="2" y="5" width="20" height="14" rx="4"/><path d="m10 9 5 3-5 3Z"/>')}</div></section><nav aria-label="Navegación del sitio"><h2>Navegación</h2><a href="/">Inicio</a><a href="/productos/?category=pantallas">Pantallas</a><a href="/micas.html">Hidrogel</a><a href="/productos-ai/">Productos AI</a><a href="/novedades/">Novedades</a><a href="/contacto/">Contacto</a></nav><section class="zay-footer-contact"><h2>Contacto</h2><a class="site-sales-footer-whatsapp" href="${quote()}" target="_blank" rel="noopener noreferrer">WhatsApp +52 33 2668 4296</a><p class="zay-footer-address-label">Dirección</p><a class="zay-footer-address" data-store-address-link href="${DIRECTIONS_URL}" target="_blank" rel="noopener noreferrer">Eje Central Lázaro Cárdenas 87<br>Piso 2, Local 225, Centro, CDMX</a><a class="zay-footer-directions" data-store-directions href="${DIRECTIONS_URL}" target="_blank" rel="noopener noreferrer">${mapPinIcon}<span>Cómo llegar</span></a><p><strong>Lun–Sáb</strong> · 10:00–18:00<br><strong>Domingo</strong> · Cerrado</p></section><section class="zay-footer-actions"><h2>HAODE</h2><a class="zay-footer-app" href="/app/">Abrir APP</a><a href="/privacidad/">Privacidad</a><a href="/garantia/">Garantía</a><a href="/terminos/">Términos de uso</a></section></div><div class="zay-footer-bottom"><span>© 2026 HAODE México</span><span>Diseño base: <a href="https://templatemo.com/tm-559-zay-shop" target="_blank" rel="noopener noreferrer">Zay Shop por TemplateMo</a></span></div></footer>`;
  }
