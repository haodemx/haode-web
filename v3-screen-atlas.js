(() => {
  ...
  function header(active = '') {
    return `<header class="v3-header reference-header topbar catalog-topbar" data-v3-header>
      ...
      <div class="v3-actions reference-nav-actions detail-header-actions">
        ...
        <a class="v3-btn v3-btn--orange detail-header-action detail-header-app reference-head-account" data-detail-header-app href="/app/"><span class="v3-mark" aria-hidden="true">A</span><span>Continuar en APP</span></a>
      </div>
    </header>`;
  }
  ...
  function homePage() {
    ...
    return `${header('')}<main>
      <section class="lab-hero"><div class="v3-wrap lab-hero-inner"><div class="lab-hero-copy"><p class="v3-eyebrow">HAODE México · Pantallas</p><h1><span>HAODE</span> Pantallas<br> profesionales</h1><p class="lab-promise">Por modelo. Por calidad. Sin confusión.</p><form class="lab-finder" action="/productos/" method="get" role="search" data-home-catalog-search-form><label class="v3-sr-only" for="lab-home-search">Busca por modelo o SKU</label><input id="lab-home-search" name="q" type="search" placeholder="Ej. iPhone 15 Pro Max" autocomplete="off" data-home-catalog-search-input><button class="v3-btn v3-btn--orange" type="submit">Encontrar modelo <span aria-hidden="true">→</span></button></form></div><div class="lab-hero-product" aria-label="Pantalla iPhone 16 Plus, vista frontal y posterior"><div class="lab-glow"></div><img class="lab-screen-front" src="/assets/products/iphone-incell/16plus/16plus白底图.jpg" alt="Pantalla iPhone 16 Plus, vista frontal y posterior"><img class="lab-screen-back" src="/assets/products/iphone-incell/16plus/背板.png" alt="Detalle de la vista posterior"><span class="lab-callout lab-callout--front">Pantalla<br>vista frontal</span><span class="lab-callout lab-callout--back">Pantalla<br>vista posterior</span><span class="lab-callout lab-callout--flex">Flex de conexión</span></div></div></section>
      ...
      <section class="lab-category-grid"><a class="lab-category lab-category--screens" href="/productos/"><span class="lab-kicker">Categoría principal</span><h2>Pantallas</h2><div class="lab-screen-lineup">${screens.map((item) => `<img src="${imageFor(item)}" alt="${esc(item.name)}">`).join('')}</div><p>iPhone · Samsung · INCELL · OLED</p></a><a class="lab-category lab-category--hydrogel" href="/micas.html"><span class="lab-kicker">Producto protagonista</span><h2>Hidrogel</h2><div class="lab-hydrogel-visual"><span>Fotografía real<br>pendiente de validación</span></div><p>HD · Matte · Privacy HD · Privacy Matte</p></a><a class="lab-category lab-category--battery" href="/baterias/"><span class="lab-kicker">Línea en preparación</span><h2>Baterías</h2><div class="lab-pending-visual"><strong>Imagen real pendiente</strong><span>No se publican modelos sin validar.</span></div></a><a class="lab-category lab-category--ai" href="/productos-ai/"><span class="lab-kicker">Catálogo actual</span><h2>Productos AI</h2>${aiProduct ? `<img src="${imageFor(aiProduct)}" alt="${esc(aiProduct.name)}">` : '<div class="lab-pending-visual">Producto real pendiente</div>'}<p>Conoce los productos publicados</p></a></section>
      <section class="lab-buying-flow">${steps()}</section>
      <section class="lab-final-cta"><div class="v3-wrap"><img src="/assets/images/factory-store-wordmark.png" alt="HAODE Refacciones para Celular"><p>Por modelo. Por calidad. Sin confusión.</p><div><a class="v3-btn" href="${quoteUrl()}" target="_blank" rel="noopener noreferrer">Consultar por WhatsApp</a><a class="v3-btn v3-btn--orange" href="/app/">Continuar en APP</a></div></div></section>
