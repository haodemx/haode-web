...
员工补视频时按下面标准给文件命名并放回共享素材库：

- 必须同 SKU 或明确同系列同品质。
- INCELL 只能补 INCELL，OLED 只能补 OLED，AMOLED / Original / Micas / AI 不能互相替代。
- Plus、Pro、Pro Max、Ultra、FE、Note 普通版不能互相替代。
- 文件名建议格式：`SKU__品质__型号__video-01.mp4`。
- 每个产品优先补 1 条 8-20 秒视频，横竖屏都可以，但画面必须能看清产品。
- 不要用泛 TikTok、门店环境、客户聊天视频代替产品视频。
...
| --- | --- |
| `S8+` 视频补 `S8` | 型号不一致 |
| `S22 Ultra` 视频补 `S22` | 型号不一致 |
| `S23 Ultra` 视频补 `S23` | 型号不一致 |
| iPhone OLED 视频补 iPhone INCELL | 品质不一致 |
...
| Samsung OLED | `samsung-oled-note-20-ultra` | Pantalla para Samsung Note 20 Ultra | OLED CON MARCO |
| Samsung OLED | `samsung-oled-note-9` | Pantalla para Samsung Note 9 | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s20` | Pantalla para Samsung S20 | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s20-ultra` | Pantalla para Samsung S20 Ultra | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s21` | Pantalla para Samsung S21 | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s21-plus` | Pantalla para Samsung S21 Plus | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s22-plus` | Pantalla para Samsung S22 Plus | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s23-plus` | Pantalla para Samsung S23 Plus | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s24-plus` | Pantalla para Samsung S24 Plus | OLED CON MARCO |
| Samsung OLED | `samsung-oled-s9-plus` | Pantalla para Samsung S9 Plus | OLED CON MARCO |
| Micas | `mica-hd` | MICA HD | Contenido: 50 pzs |
| Micas | `mica-matte` | MICA MATTE | Contenido: 50 pzs |
| Micas | `mica-privacidad-hd` | MICA PRIVACIDAD HD | Contenido: 50 pzs |
| Micas | `mica-privacidad-matte` | MICA PRIVACIDAD MATTE | Contenido: 50 pzs |
| Gafas AI | `haode-ai-g3-smart-glasses` | Gafas Inteligentes AI G3 | HAODE AI G3 Smart Glasses |
| Gafas AI | `haode-ai-w610-smart-glasses` | Gafas Inteligentes AI W610 | HAODE AI W610 Smart Glasses |
| Gafas AI | `s1-ai-classic` | HAODE AI CLASSIC S1 | Gafas AI classic |
| Gafas AI | `aimb-g5-ai-sports` | AIMB-G5 AI SPORTS | Gafas AI deportivas |
| Camaras Inteligentes | `lk-007-camara-digital-4k` | Camara Digital 4K LK-007 | Camara Digital 4K |
| Camaras Inteligentes | `lk-030-mini-camara-retro-digital` | LK-030 Mini Camara Retro Digital | Camara digital compacta |
| Camaras Inteligentes | `lk-032-camara-inteligente-con-gimbal` | LK-032 Camara Inteligente con Gimbal | Camara inteligente con gimbal |
| Gafas AI | `w630-ai-pro` | W630 AI PRO | Gafas AI blancas |
